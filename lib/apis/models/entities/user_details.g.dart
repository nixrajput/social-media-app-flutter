...
abstract class _$UserDetailsCWProxy {
  ...
  UserDetails followingCount(int followingCount);
  ...
  UserDetails isValid(bool isValid);
...
class _$UserDetailsCWProxyImpl implements _$UserDetailsCWProxy {
  ...
  @override
  UserDetails isValid(bool isValid) => this(isValid: isValid);
...
extension $UserDetailsCopyWith on UserDetails {
  /// Returns a callable class that can be used as follows: `instanceOfUserDetails.copyWith(...)` or like so:`instanceOfUserDetails.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$UserDetailsCWProxy get copyWith => _$UserDetailsCWProxyImpl(this);
}
