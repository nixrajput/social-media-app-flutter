...
abstract class _$LoginInfoCWProxy {
  ...
  LoginInfo deviceOsVersion(String? deviceOsVersion);
  ...
  LoginInfo call({
    ...
    return LoginInfo(
      ...
      deviceOs: deviceOs == const $CopyWithPlaceholder()
          ...
          // ignore: cast_nullable_to_non_nullable
          : deviceOs as String?,
      deviceOsVersion: deviceOsVersion == const $CopyWithPlaceholder()
...
extension $LoginInfoCopyWith on LoginInfo {
  /// Returns a callable class that can be used as follows: `instanceOfLoginInfo.copyWith(...)` or like so:`instanceOfLoginInfo.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$LoginInfoCWProxy get copyWith => _$LoginInfoCWProxyImpl(this);
}
...
LoginInfo _$LoginInfoFromJson(Map<String, dynamic> json) => LoginInfo(
      ...
      resultAs: json['resultAs'] as String?,
