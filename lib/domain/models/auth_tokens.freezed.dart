...
mixin _$AuthTokens {
 ...
 String get accessToken; DateTime get accessExpiresAt; String get refreshToken; DateTime get refreshExpiresAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,accessToken,accessExpiresAt,refreshToken,refreshExpiresAt);

@override
String toString() {
  return 'AuthTokens(accessToken: $accessToken, accessExpiresAt: $accessExpiresAt, refreshToken: $refreshToken, refreshExpiresAt: $refreshExpiresAt)';
}
...
/// Create a copy of AuthTokens
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessToken = null,Object? accessExpiresAt = null,Object? refreshToken = null,Object? refreshExpiresAt = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String accessToken,  DateTime accessExpiresAt,  String refreshToken,  DateTime refreshExpiresAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthTokens() when $default != null:
return $default(_that.accessToken,_that.accessExpiresAt,_that.refreshToken,_that.refreshExpiresAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String accessToken,  DateTime accessExpiresAt,  String refreshToken,  DateTime refreshExpiresAt)  $default,) {final _that = this;
switch (_that) {
case _AuthTokens():
return $default(_that.accessToken,_that.accessExpiresAt,_that.refreshToken,_that.refreshExpiresAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String accessToken,  DateTime accessExpiresAt,  String refreshToken,  DateTime refreshExpiresAt)?  $default,) {final _that = this;
switch (_that) {
case _AuthTokens() when $default != null:
return $default(_that.accessToken,_that.accessExpiresAt,_that.refreshToken,_that.refreshExpiresAt);case _:
  return null;
...
class _AuthTokens implements AuthTokens {
  const _AuthTokens({required this.accessToken, required this.accessExpiresAt, required this.refreshToken, required this.refreshExpiresAt});
...
/// Create a copy of AuthTokens
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accessToken = null,Object? accessExpiresAt = null,Object? refreshToken = null,Object? refreshExpiresAt = null,}) {
